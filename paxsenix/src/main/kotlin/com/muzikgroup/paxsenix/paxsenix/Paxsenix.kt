package com.muzikgroup.paxsenix

import android.content.Context
import com.muzikgroup.music.betterlyrics.TTMLParser
import com.muzikgroup.paxsenix.models.AppleMusicSearchResponse
import com.muzikgroup.paxsenix.models.LyricsResponse

import com.muzikgroup.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "Muzik/$appVersion")
                }
