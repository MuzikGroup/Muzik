...
import com.muzikgroup.innertube.NewPipeExtractor
...
import com.muzikgroup.innertube.strategy.ContentAwareFallbackStrategy
import com.muzikgroup.innertube.strategy.ContentHints
import com.muzikgroup.music.constants.AudioQuality
import com.muzikgroup.music.utils.YTPlayerUtils.MAIN_CLIENT
import com.muzikgroup.music.utils.YTPlayerUtils.validateStatus
import com.muzikgroup.music.utils.cipher.CipherDeobfuscator
import com.muzikgroup.music.utils.cipher.FunctionNameExtractor
import com.muzikgroup.music.utils.cipher.PlayerJsFetcher
import com.muzikgroup.music.utils.potoken.PoTokenGenerator
import com.muzikgroup.music.utils.potoken.PoTokenResult
...
object YTPlayerUtils {
    ...
    suspend fun playerResponseForPlayback(
        ...
        if (streamPlayerResponse.playabilityStatus.status != "OK") {
            ...
            // unavailable streams; Muzik cannot recover those without official playback.
