            ...
            remember {
                songSelection
                    .map { song ->
                        ...
                        val metadata = song.toMediaMetadata()
                        com.muzikgroup.music.db.entities.Song(
                            song =
                                com.muzikgroup.music.db.entities.SongEntity(
                                    id = metadata.id,
                            ...
                            artists =
                                metadata.artists.map { artist ->
                                    com.muzikgroup.music.db.entities.ArtistEntity(
                                        id = artist.id ?: "",
                                        name = artist.name,
                                    )
                                },
                            album =
                                metadata.album?.let { album ->
                                    com.muzikgroup.music.db.entities.AlbumEntity(
                                        id = album.id,
                                        title = album.title,
