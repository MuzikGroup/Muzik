package com.muzikgroup.music.discord
...
import com.muzikgroup.music.discord.DiscordDefaults.DISCORD_OAUTH_AUTHORIZE
import com.muzikgroup.music.discord.DiscordDefaults.DISCORD_OAUTH_TOKEN
import com.muzikgroup.music.discord.DiscordDefaults.DISCORD_SCOPES
...
class DiscordAuth(
    ...
    companion object {
        ...
        const val REDIRECT_URI = "muzikdiscord://oauth2/callback"
