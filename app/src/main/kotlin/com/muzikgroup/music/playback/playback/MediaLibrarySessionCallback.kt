...
import com.muzikgroup.music.constants.AndroidAutoSearchLocalLimitKey
...
import com.muzikgroup.music.constants.AndroidAutoSectionsOrderKey
import com.muzikgroup.music.constants.AndroidAutoYouTubePlaylistsKey
...
import com.muzikgroup.music.ui.screens.settings.AndroidAutoSection
import com.muzikgroup.music.ui.screens.settings.deserializeSections
import com.muzikgroup.music.ui.screens.settings.serializeSections
                ...
                when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.muzikgroup.innertube.pages.HomePage.Section>()
