...
# Since Muzik is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.muzikgroup.music.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.muzikgroup.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class com.muzikgroup.music.utils.cipher.** { *; }
-keep class com.muzikgroup.music.utils.potoken.** { *; }
...
-keep class com.muzikgroup.music.models.PersistQueue { *; }
-keep class com.muzikgroup.music.models.PersistPlayerState { *; }
-keep class com.muzikgroup.music.models.QueueData { *; }
-keep class com.muzikgroup.music.models.QueueType { *; }
-keep class com.muzikgroup.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.muzikgroup.music.cast.** { *; }
...
-keep class com.muzikgroup.music.recognition.VibraSignature { *; }
-keepclassmembers class com.muzikgroup.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.muzikgroup.music.listentogether.proto.** { *; }
-keepclassmembers class com.muzikgroup.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.muzikgroup.shazamkit.models.** { *; }
-keepclassmembers class com.muzikgroup.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.muzikgroup.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.muzikgroup.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.muzikgroup.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}
