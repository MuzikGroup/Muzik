...
val baseApplicationId = "com.muzikgroup.music"
val applicationIdOverride = System.getenv("MUZIK_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("MUZIK_APP_NAME")?.takeIf { it.isNotBlank() }
val debugKeystorePathOverride = System.getenv("MUZIK_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("MUZIK_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("MUZIK_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("MUZIK_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
...
android {
    namespace = "com.muzikgroup.music"
    compileSdk = 37
    ...
    defaultConfig {
        ...
        versionCode = 1
        versionName = "1.0.0"
        resValue("string", "app_name", appNameOverride ?: "Muzik")

        testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner"
        vectorDrawables.useSupportLibrary = true

        ndk {
            abiFilters += if (architectureOverride == "universal") {
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "Muzik")
            }
            signingConfig =
...
val protoDir = rootProject.file("muzzproto")
